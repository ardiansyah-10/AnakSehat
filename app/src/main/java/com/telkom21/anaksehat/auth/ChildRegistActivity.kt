...
import com.telkom21.anaksehat.databinding.ActivityChildRegistBinding

class ChildRegistActivity : AppCompatActivity() {
    private lateinit var binding: ActivityChildRegistBinding
    private lateinit var database: FirebaseDatabase
    private lateinit var usersRef: DatabaseReference
    override fun onCreate(savedInstanceState: Bundle?) {
        binding = ActivityChildRegistBinding.inflate(layoutInflater)
        ...
        binding.saveBtn.setOnClickListener {
            ...
            if (umurString.toIntOrNull() != null) {  // Check if umur is a valid integer
                ...
                val childPath = if (umurString.toInt() in 0..24) {
                    ...
                    Toast.makeText(this@ChildRegistActivity,
                        "Umur yang dimasukkan tidak boleh lebih dari 60 bulan.",
